...
def banner():
	os.system("clear")
	print(f"""{B}
            â–ˆâ–ˆâ–ˆâ–ˆâ–ˆ  â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆ â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆ â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆ      â–ˆâ–ˆâ–ˆ    â–ˆâ–ˆâ–ˆ â–ˆâ–ˆ    â–ˆâ–ˆ 
           â–ˆâ–ˆ   â–ˆâ–ˆ â–ˆâ–ˆ      â–ˆâ–ˆ      â–ˆâ–ˆ   â–ˆâ–ˆ     â–ˆâ–ˆâ–ˆâ–ˆ  â–ˆâ–ˆâ–ˆâ–ˆ  â–ˆâ–ˆ  â–ˆâ–ˆ  
           â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆ â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆ â–ˆâ–ˆâ–ˆâ–ˆâ–ˆ   â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆ      â–ˆâ–ˆ â–ˆâ–ˆâ–ˆâ–ˆ â–ˆâ–ˆ   â–ˆâ–ˆâ–ˆâ–ˆ   
           â–ˆâ–ˆ   â–ˆâ–ˆ      â–ˆâ–ˆ â–ˆâ–ˆ      â–ˆâ–ˆ          â–ˆâ–ˆ  â–ˆâ–ˆ  â–ˆâ–ˆ    â–ˆâ–ˆ    
           â–ˆâ–ˆ   â–ˆâ–ˆ â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆ â–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆâ–ˆ â–ˆâ–ˆ          â–ˆâ–ˆ      â–ˆâ–ˆ    â–ˆâ–ˆ    """)
def cek_cookie():
	try:
...
def login():
	banner()
	x=f"{P2}halo pengguna script dump ASEP YUSUP :)\n{P2}silahkan pilih fitur login cookie untuk melanjutkan ke menu dump multi fast.. klo tidak mengerti apaÂ² bisa ketik {M2}help {P2}untuk meminta bantuan !!"
	vprint(panel(x,style=f"{H3}"))
	print("")
	x=f"{P2}[01] login with cookie\n{P2}[02] report bug script\n{P2}[{M2}00{P2}] exit "
	vprint(panel(x,style=f"{H3}"))
	cukuf = input(f" {P}[{H}â€¢{P}] pilih : {H}")
...
def menu():
	...
	vprint(panel(x,style=f"{H3}"))
	print("")
	x=f"{P2} â”Œâ”€ selamat datang {K2}{nama}\n{P2} â”‚ â””â”€ tanggal lahirmu : {H2}{pko}\n{P2} â”‚ â””â”€ ID kamu : {H2}{tumbal_id}\n{P2} â”‚ â””â”€ IP kamu : {H2}{IP}\n{P2} â”‚ â”Œâ”€ negara kamu : {H2}{nibba}\n{P2} â””â”€ tanggal sekarang : {H2}{sekarang}"
	vprint(panel(x,style=f"{H3}"))
	print("")
